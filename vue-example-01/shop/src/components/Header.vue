      ...
      <div class="wrap_header">
        ...
        <div class="wrap_menu">
          <nav class="menu">
            <ul class="main_menu">
              <!--
              Vue Router에서 제공하는 라우터 링크 컴포넌트를 사용함
              to attribute에 home이라고 name을 지정해주고 a태그를 감쌀 태그명을 지정함 tag="li"
              url과 라우터에 지정된 home url이 동일할 경우, sale-noti라는 클래스명을 적용해주기 위해
              active-class에 지정해주고 url 매칭 테스트를 좀 더 정확히 하기 위해 exact attribute를 추가해줌
              -->
